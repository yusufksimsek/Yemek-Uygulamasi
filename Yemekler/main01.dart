...
import 'package:listview_yemekuygulamasi/Yemekler/DetaySayfasi.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<List<Yemekler>> yemekleriGetir() async{
      ...
      var y1 = Yemekler(1, "Köfte", "kofte.png", 45.99);
      var y2 = Yemekler(2, "Ayran", "ayran.png", 4.99);
      var y3 = Yemekler(3, "Fanta", "fanta.png", 8.0);
      var y4 = Yemekler(4, "Makarna", "makarna.png", 34.45);
      var y5 = Yemekler(5, "Kadayıf", "kadayif.png", 22.50);
      var y6 = Yemekler(6, "Baklava", "baklava.png", 15.00);
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 50,),
                          Text("${yemek.yemek_fiyat} \u{20BA}",style: TextStyle(fontSize: 22,color: Colors.blue),),
                        ],
                      ),
                      Spacer(),
